...
<!-- AUTO:RECENT:START -->
- **[AIProxyHub](https://github.com/WJH-makers/AIProxyHub)**　<sub>`2026-09-16`</sub> — Windows 本地优先的 AI 网关管理器：管理用户已授权的 provider、OpenAI-compatible 转发、按凭据隔离的缓存与限流。不创建账户、不规避 provider 限额。
